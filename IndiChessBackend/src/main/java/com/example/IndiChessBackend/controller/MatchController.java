...
public class MatchController {
    ...
    // Create a RAPID (10-minute) match
    @PostMapping("/rapid")
    public ResponseEntity<Map<String, Long>> createRapidMatch(HttpServletRequest request) {
        Optional<Long> matchIdOpt = matchService.createRapidMatch(request);
    ...
    // Check RAPID match status
    @GetMapping("/check-rapid-match")
    public ResponseEntity<Map<String, Long>> checkRapidMatch(HttpServletRequest request) {
        Optional<Long> matchIdOpt = matchService.checkRapidMatch(request);
    ...
    // Cancel RAPID waiting
    @PostMapping("/cancel-rapid-waiting")
    public ResponseEntity<Map<String, Boolean>> cancelRapidWaiting(HttpServletRequest request) {
        boolean cancelled = matchService.cancelRapidWaiting(request);
